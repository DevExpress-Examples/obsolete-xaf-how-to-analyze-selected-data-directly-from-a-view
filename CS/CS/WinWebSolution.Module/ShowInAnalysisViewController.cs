...
namespace WinWebSolution.Module {
    ...
    public class ShowInAnalysisViewController : ViewController {
        ...
        protected override void UpdateActionActivity(ActionBase action) {
            ...
            IModelClassReportsVisibility visibleInReportsModel = ((IModelObjectView)View.Model).ModelClass as IModelClassReportsVisibility;
    ...
    object dataSource = e.DataSource;
    if(dataSource is ProxyCollection)
        dataSource = ((ProxyCollection)dataSource).OriginalCollection;
    XPCollection collection = dataSource as XPCollection;
    if(collection != null)
        collection.Criteria &= selectionCriteria;
}
